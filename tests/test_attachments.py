...
class TestAttachmentLimits:
    ...
    def test_attachment_total_size_exceeded(self, server, api_headers):
        ...
        payload = {
            "instruction": "分析文件",
            "attachments": [
                {"type": "file", "name": "file1.dat", "content": large_base64},
                {"type": "file", "name": "file2.dat", "content": large_base64},
                {"type": "file", "name": "file3.dat", "content": large_base64},
                {"type": "file", "name": "file4.dat", "content": large_base64}
            ]
        }
